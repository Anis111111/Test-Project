"""
Django settings for pmarket project.
...
SECRET_KEY = 'django-insecure-_l^ggoxk-n(lpowdc#*2bf-^f@t44-r&rrkhuvub@2@jy6yz=6'
...
INSTALLED_APPS = [
    ...
    'professor.apps.ProfessorConfig',   # new 
...
WSGI_APPLICATION = 'pmarket.wsgi.application'
